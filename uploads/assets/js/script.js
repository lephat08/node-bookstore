...
let navitem_length = $("ul.pcoded-item>li>a").length;
for(let i = 0; i<navitem_length; i++){
	let user_url = window.location.href;
	let my_url = $("ul.pcoded-item>li>a")[i].href;
	
	if(get_last_url(user_url) ===get_last_url(my_url)){
		console.log("ul.pcoded-item>li:nth-child("+eval(i+1)+")");
		$("ul.pcoded-item>li:nth-child("+eval(i+1)+")").addClass("active");
	}
}
